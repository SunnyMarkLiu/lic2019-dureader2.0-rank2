...
nohup python run.py --train --gpu 3 --data_type zhidao --desc 'pure_v5' --max_a_len 400 --train_answer_len_cut_bins 6 --evaluate_every_batch_cnt 2000 > zhidao_train.log 2>&1 &
```
