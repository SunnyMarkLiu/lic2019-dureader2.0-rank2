...
nohup cat ${source_cleaned_dir}split_search_00 |python 2.extract_paragraph.py train ${MAX_DOC_LEN} > ${target_extracted_dir}split_search_00 2>&1 &
nohup cat ${source_cleaned_dir}split_search_01 |python 2.extract_paragraph.py train ${MAX_DOC_LEN} > ${target_extracted_dir}split_search_01 2>&1 &
nohup cat ${source_cleaned_dir}split_search_02 |python 2.extract_paragraph.py train ${MAX_DOC_LEN} > ${target_extracted_dir}split_search_02 2>&1 &
nohup cat ${source_cleaned_dir}split_search_03 |python 2.extract_paragraph.py train ${MAX_DOC_LEN} > ${target_extracted_dir}split_search_03 2>&1 &
...
nohup cat ${source_cleaned_dir}split_zhidao_02 |python 2.extract_paragraph.py train ${MAX_DOC_LEN} > ${target_extracted_dir}split_zhidao_02 2>&1 &
nohup cat ${source_cleaned_dir}split_zhidao_03 |python 2.extract_paragraph.py train ${MAX_DOC_LEN} > ${target_extracted_dir}split_zhidao_03 2>&1 &
...
nohup cat ${cleaned_devset_dir}search.dev.json |python 2.extract_paragraph.py dev ${MAX_DOC_LEN} > ${extracted_devset_dir}search.dev.json 2>&1 &
nohup cat ${cleaned_devset_dir}zhidao.dev.json |python 2.extract_paragraph.py dev ${MAX_DOC_LEN} > ${extracted_devset_dir}zhidao.dev.json 2>&1 &

nohup cat ${cleaned_devset_dir}cleaned_18.search.dev.json |python 2.extract_paragraph.py dev ${MAX_DOC_LEN} > ${extracted_devset_dir}cleaned_18.search.dev.json 2>&1 &
nohup cat ${cleaned_devset_dir}cleaned_18.zhidao.dev.json |python 2.extract_paragraph.py dev ${MAX_DOC_LEN} > ${extracted_devset_dir}cleaned_18.zhidao.dev.json 2>&1 &
