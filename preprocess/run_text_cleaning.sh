...
#------------------------ train raw data ------------------------
source_raw_dir='../input/dureader_2.0/raw/trainset/'
target_cleaned_dir='../input/dureader_2.0/cleaned/trainset/'
...
# 去年的 dev 数据
nohup cat ${raw_devset_dir}18.search.dev.json |python 1.text_cleaning.py > ${cleaned_devset_dir}18.search.dev.json 2>&1 &
nohup cat ${raw_devset_dir}18.zhidao.dev.json |python 1.text_cleaning.py > ${cleaned_devset_dir}18.zhidao.dev.json 2>&1 &

#------------------------ test raw data ------------------------
source_raw_dir='../input/dureader_2.0/raw/testset/'
target_cleaned_dir='../input/dureader_2.0/cleaned/testset/'
